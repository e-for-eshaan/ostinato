...
export const LogoHeading: React.FC<LogoHeadingProps> = ({
  ...
  if (type == 'h1') {
    ...
    return (
      <h2 className={`${className} md:text-[150px] text-[100px] font-Righteous leading-none`}>
        {children}
      </h2>
    );
  } else if (type == 'h3') {
    return (
      <h3 className={`${className} md:text-[150px] text-[100px] font-Righteous leading-none`}>
        {children}
      </h3>
    );
  } else if (type == 'h4') {
    return (
      <h4 className={`${className} md:text-[150px] text-[100px] font-Righteous leading-none`}>
        {children}
      </h4>
    );
  } else if (type == 'h5') {
    return (
      <h5 className={`${className} md:text-[150px] text-[100px] font-Righteous leading-none`}>
        {children}
      </h5>
    );
  } else {
